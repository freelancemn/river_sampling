abbreviations = {
    ...
    "Streamflow, ft&#179;/s": ["Q", "Streamflow", "ft3/s"],
    "Gage height, ft": ["GH", "Gage Height", "ft"],
    "Dissolved oxygen, water, unfiltered, mg/L": ["DO", "Disolved Oxygen", "mg/L"],
    ...
    "Nitrate plus nitrite, water, in situ, mg/L as N": ["NO3", "Nitrate", "mg/L"],
